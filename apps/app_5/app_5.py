...
def run(screen):
    ...
    BUTTON_POS = (CENTER[0], CENTER[1] + 100)  # Botão play/pause está mais alto
    BUTTON_RADIUS = 30  # Tamanho do botão play/pause
    BACK_BUTTON_POS = (40, 40)  # Botão "voltar" movido para o canto inferior esquerdo
    ...
    button_images = {
        'start': pygame.image.load('./apps/app_5/start_button.png'),
        'pause': pygame.image.load('./apps/app_5/pause_button.png'),
        'stop': pygame.image.load('./apps/app_5/stop_button.png')
    }
